...
![Timer Running](res/timer_running.png)

If the user changes the tab or opens some other window, the timer is stopped.
![Timer Interrupted](res/timer_interrupted.png)
